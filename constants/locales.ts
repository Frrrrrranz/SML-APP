    ...
    zh: {
        ...
        cloud: {
            ...
            form: {
                ...
                selectFile: '选择文件',
                changeFile: '更换文件',
                sheetSelectHint: '支持 PDF 或图片，图片将自动合成 PDF',
                multiAppend: '多选追加模式',
                addMoreImages: '继续添加图片',
                sheetOrderHint: '页序确认（将按以下顺序合成）',
            },
            save: '保存',
            sheetMusicTab: '乐谱',
            recordingsTab: '录音',
            ...
            updatePortrait: '更换头像',
            restoreDefault: '恢复默认',
            deleteWorkConfirm: '确定要删除这份乐谱吗？',
            deleteRecordingConfirm: '确定要删除这个录音吗？',
        ...
        update: {
            ...
            failedDesktopAppDesc: '桌面安装包更新失败，请稍后重试或手动下载安装最新版本。',
            failedDesktopWebDesc: '桌面 OTA 更新失败，请稍后重试；若持续失败，可检查对应的 Desktop Web OTA Release。',
            now: '立即更新',
            later: '稍后',
            restart: '立即重启',
            retry: '重试',
    ...
    en: {
        ...
        cloud: {
            ...
            form: {
                ...
                sheetSelectHint: 'Select PDF or images. Multiple images will be combined into one PDF.',
                multiAppend: 'Multi-select append',
                addMoreImages: 'Add more images',
                sheetOrderHint: 'Page order (used for merge)',
            },
            save: 'Save',
            sheetMusicTab: 'Sheet Music',
            recordingsTab: 'Recordings',
            noSheetMusic: 'No Sheet Music Yet',
            noRecordings: 'No Recordings Yet',
            updatePortrait: 'Update Portrait',
            restoreDefault: 'Restore Default',
            deleteWorkConfirm: 'Delete this sheet music?',
        ...
        update: {
            ...
            failedDesktopAppDesc: 'Desktop app update failed. Please try again later or install the latest version manually.',
            failedDesktopWebDesc: 'Desktop OTA update failed. Please try again later and verify the matching Desktop Web OTA release if needed.',
            now: 'Update Now',
            later: 'Later',
            restart: 'Restart Now',
            retry: 'Retry',
